...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">    
    ...
    <head>
        ...
        <title>Macro Media - About Us</title>
            ...
            <div class="container">
                <div class="row justify-content-center">                    
                    <div class="card col-12 col-lg">
                        <h6 class="mbr-text mbr-fonts-style display-7 justify-content-lg-start">&nbsp;About us</h6><br>
                        <div class="card-wrapper">                            
                            <h6 class="card-title mbr-fonts-style mb-4 display-2"><strong>Macro Media</strong></h6>
                            <p class="mbr-text mbr-fonts-style display-7">
                            Is a marketing agency that helps small and medium enterprises (SMEs)  to expand their business by increasing their sales and building their online presence. We are focused on assisting business owners to develop a strong strategy to keep up with their competitors. <br><br><br>

                            “We help our clients to level up and EXPAND their business so that any customers will recognize their brand”
                            </p>
                            <div class="mbr-section-btn pt-3"><a class="btn btn-primary display-4" href="https://mobiri.se">Read More</a></div>
                        </div>
                    </div>
                        ...
                        <div class="card-wrap">
                            ...
                            <div class="content-wrap">
                                ...
                                <div class="social-row display-7">
                                    <div class="soc-item">
                                        <a href="https://www.facebook.com/JayMarco08" style="text-decoration: none;" target="_blank">
                                            <span class="mbr-iconfont socicon socicon-facebook"></span>
                                        </a>
                                    </div>
                                    <div class="soc-item">
                                        <a href="https://twitter.com/mobirise" style="text-decoration: none;" target="_blank">
                                            <span class="mbr-iconfont socicon socicon-twitter"></span>
                                        </a>
                                    </div>
                                    <div class="soc-item">
                                        <a href="https://www.instagram.com/kuya_jhake" style="text-decoration: none;" target="_blank">                                                
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="card-wrap">
                            ...
                            <div class="content-wrap">
                                ...
                                <div class="social-row display-7">
                                    <div class="soc-item">
                                        <a href="https://www.facebook.com/ChristianGarcia4201" style="text-decoration: none;" target="_blank">
                                            <span class="mbr-iconfont socicon socicon-facebook"></span>
                                        </a>
                                    </div>
                                    <div class="soc-item">
                                    ...
                                    <div class="soc-item">
                                        <a href="https://www.instagram.com/iam_christian01" style="text-decoration: none;" target="_blank">
                                            <span class="mbr-iconfont socicon socicon-instagram"></span>
                                        </a>
                                    </div>
                    ...
                    <div class="col-sm-6 col-lg-4 ">
                        <div class="card-wrap">
                            ...
                            <div class="content-wrap">
                                ...
                                <div class="social-row display-7">
                                    <div class="soc-item">
                                        <a href="https://www.facebook.com/Mobirise/" style="text-decoration: none;" target="_blank">
                                            <span class="mbr-iconfont socicon socicon-facebook"></span>
                                        </a>
                                    </div>
                                    <div class="soc-item">
                                    ...
                                    <div class="soc-item">
                                        <a href="https://instagram.com/mobirise" style="text-decoration: none;" target="_blank">
                                            <span class="mbr-iconfont socicon socicon-instagram"></span>
                                        </a>
                                    </div>
